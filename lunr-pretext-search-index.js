...
},
{
  ...
  "body": "  From May and Bart: This book got its start at a talk by Felkel and Richardson at ICTCM in 2000 where they claimed \"Business students should be taught math using spreadsheets.\" A number of years later I tried teaching with their book and found much to appreciate from their approach. Their book, Networked Business Mathematics, is the initial inspiration of this book. However, as often happens when an academic looks at a textbook, I found the authors had made some choices I disagreed with, so I wanted to write my own text. As I was going through beta versions of this book, I discovered the 2004 report of the Curriculum Reform Across the First Two Years (CRAFTY) sub-committee of the Mathematical Association of America (MAA), and the MAA's 2004 curriculum guide. That report has guided many decisions concerning this text.  The book has been rewritten in PreTeXt ( https:\/\/pretextbook.org\/index.html ), making it possible to quickly output print, web, PDF versions and more from the same source.  The continued development of my attempt to make courses that better fit the needs of business students has received support from the National Science Foundation (Award #DUE-16251423.)  From Sarah Williams: I am grateful to Mike May for sharing and allowing me to customize this work. Thanks also to Ted Pier for helping with technology.  "
},
{
  "id": "frontmatter-6",
  "level": "1",
...
{
  "id": "sec-1-1-LinearFunctionsAndModels-5-4",
  "level": "2",
  "url": "sec-1-1-LinearFunctionsAndModels.html#sec-1-1-LinearFunctionsAndModels-5-4",
  "type": "Example",
  "number": "1.1.3",
  "title": "Supply and Demand Curves.",
  "body": " Supply and Demand Curves  Supply and demand equations are often modeled by linear equations. In the figure below we see a supply and demand diagram. The vertical axis measures the price of a good, and the horizontal axis measures quantity. Both supply (S) and demand (D) are linear functions in this example.   As we read the graph of the supply function, S, from left-to-right, we see the curve rises or \"increases.\" We say the supply function has positive slope , and this indicates that more producers join a market as the price of a good rises.  As we read the graph of the demand function, D, from left-to-right, we see the curve falls or \"decreases.\" We say the demand function has negative slope , indicating that fewer consumers purhcase a good as its price rises.   Linear supply and demand curves   The intersection of a supply and demand curve    "
},
{
  "id": "sec-1-1-LinearFunctionsAndModels-5-9",
  "level": "2",
  "url": "sec-1-1-LinearFunctionsAndModels.html#sec-1-1-LinearFunctionsAndModels-5-9",
  "type": "Example",
  "number": "1.1.5",
...
{
  "id": "sec-1-1-LinearFunctionsAndModels-5-10",
  "level": "2",
  "url": "sec-1-1-LinearFunctionsAndModels.html#sec-1-1-LinearFunctionsAndModels-5-10",
  "type": "Example",
  "number": "1.1.6",
...
{
  "id": "sec-1-1-LinearFunctionsAndModels-5-11",
  "level": "2",
  "url": "sec-1-1-LinearFunctionsAndModels.html#sec-1-1-LinearFunctionsAndModels-5-11",
  "type": "Example",
  "number": "1.1.7",
...
{
  "id": "Reading_Check_Sec2.2",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#Reading_Check_Sec2.2",
  "type": "Reading Question",
  "number": "2.2.6.1",
...
{
  "id": "exercises-set-sec-2-2-2-3",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-3",
  "type": "Exercise",
  "number": "2.2.7.2",
  "title": "",
  "body": "  Given and , with .   "
...
{
  "id": "exercises-set-sec-2-2-2-4",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-4",
  "type": "Exercise",
  "number": "2.2.7.3",
  "title": "",
...
{
  "id": "exercises-set-sec-2-2-2-5",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-5",
  "type": "Exercise",
  "number": "2.2.7.4",
  "title": "",
  "body": "  Given and , with .   "
...
{
  "id": "exercises-set-sec-2-2-2-6",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-6",
  "type": "Exercise",
  "number": "2.2.7.5",
  "title": "",
  "body": "  Given demand price and cost are the linear functions that best fit the data below and that .    Quantity 50 100   Demand price 10 8   Cost 300 450        If the table only has 2 data points, Excel can get confused wether the data is in rows or columns. We duplicated one column to get the data plotted correctly.   Identify the fixed and variable costs.   , and the (per unit).    Find the revenue and profit functions.    .    Evaluate cost, demand price, revenue, and profit at .  At , , , , and    Find all break-even points.  The break-even points, found with goal seek, are and    Graph the profit function over a domain that includes both break-even points. Add a textbox and label to identify the first break-even point.    Entries in the cells before quick fill     Table plus extra columns for the brek even points    The graph produced in Excel. To create the labels: double click on one of the break-even points, go to Chart Layout , go to Data Labels . In this example we chose the x-value . Both break-even points were labeled to show where they are and what the values are in this problem.      "
...
{
  "id": "exercises-set-sec-2-2-2-7",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-7",
  "type": "Exercise",
  "number": "2.2.7.6",
  "title": "",
...
{
  "id": "exercises-set-sec-2-2-2-8",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-2-8",
  "type": "Exercise",
  "number": "2.2.7.7",
  "title": "",
...
{
  "id": "exercises-set-sec-2-2-3",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-3",
  "type": "Exercise",
  "number": "2.2.7.9",
  "title": "",
...
{
  "id": "exercises-set-sec-2-2-4-3",
  "level": "2",
  "url": "sec-2-2-ModelingRevenueCostProfit.html#exercises-set-sec-2-2-4-3",
  "type": "Exercise",
  "number": "2.2.7.11",
  "title": "",
...
},
{
  ...
  "body": " Reading check, 3.2, Numeric Derivatives and Limits,    This question checks your reading comprehension of the material is section 3.2, Numeric Derivatives and Limits, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    The calculator definition of derivative approximates by .    The calculator definition of derivative has problems with corners and cusps.    If the derivative of is positive, the graph of the function , is increasing.    For a function , the derivative is defined as the limit as approaches 0 of .    If the derivative of is negative, the graph of the function , is increasing.    The calculator definition of the derivative gives a good approximation for all functions.).    None of the above              "
},
{
...
},
{
  ...
  "body": " Reading check, Differentiation Using Computer Algebra    This question checks your reading comprehension of the material is section 4.4, Differentiation Using Computer Algebra, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    The free tools for differentiation all use the same syntax.    Desmos is a free tool available on the web that does symbolic differentiation.    Wolfram|Alpha is a free tool available on the web that does symbolic differentiation.    Differentiation can be done with free tools available on the web.    Some free tools give step by step work for symbolic differentiation.    Symbolab is a free tool available on the web that does symbolic differentiation.    None of the above              "
},
{
...
},
{
  ...
  "body": " Reading check, Related Rates    This question checks your reading comprehension of the material is section 5.2, Related Rates, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    The related rates technique is an application of the chain rule.    Related rates and implicit differentiation are interchangeable methods.    Related rates are useful when we are looking at a two variables related by some constraint or equation and both are varying with time.    Related rates are useful when we are looking at a two-step process and we are interested in the rate of the combined process.    We always can use algebra to reduce to two variables, so we do not really need related rates.    When using the method of related rates, we act as if the derivatives are fractions that we can multiply or divide to obtain the appropriate fraction.    None of the above              "
},
{
...
},
{
  ...
  "body": " Reading check, Evaluating and Graphing Functions of Several Variables    This question checks your reading comprehension of the material is section 6.1, Evaluating and Graphing Functions of Several Variables, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    Wolfram Alpha will plot functions of two variables.    In the text, bank balance was discussed as a function of 4 variables.    The book showed how to make a table for functions of two variables.    Excel easily graphs functions of three variables.    All functions have a single input variable, x    In the text, the demand price of an object was discussed as a function of 5 variables, 2 given demands with associated prices and the demand quantity in question.    None of the above              "
},
{
...
},
{
  ...
  "body": " Reading check, Integration Using Computer Algebra    This question checks your reading comprehension of the material is section 7.5, Integration Using Computer Algebra, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    Wolfram|Alpha will also do definite integrals.    The section uses Symbolab as a computer algebra system that will do integration.    The section uses GeoGebra as a computer algebra system that will do integration.    In initial value problems, we have to solve for the value of the integration constant .    The section uses Wolfram|Alpha as a computer algebra system that will do integration.    The computer algebra systems used in this section cannot do Riemann sums.    None of the above              "
},
{
...
},
{
  ...
  "body": " Reading check, The Normal Distribution: An Extended Numeric Example    This question checks your reading comprehension of the material is section 7.6, The Normal Distribution: An Extended Numeric Example, of Business Calculus with Excel. Based on your reading, select all statements that are correct. There may be more than one correct answer. The statements may appear in what seems to be a random order.    Each method described has advantages and disadvantages. .    The method of using CAS is always the best method.    One method in the sections was described as Excel with Riemann sums.    One method in the sections was described as CAS.    One method in the sections was described as Statistical Averaging.    The method of using Excel with Riemann sums is always the best method.    One method in the sections was described as Excel with formulas.    The section uses Symbolab as a computer algebra system that will do integration.    One method in the sections was described as Integration by parts.    None of the above              "
},
{
